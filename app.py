...
# === Forecasting ===
historical_ev = list(county_df['Electric Vehicle (EV) Total'].astype(float).values[-6:])
...
if multi_counties:
    ...
    for cty in multi_counties:
        ...
        hist_ev = list(cty_df['Electric Vehicle (EV) Total'].astype(float).values[-6:])
...
st.markdown("Prepared for the **VEDAREDDY GADDAM**")
